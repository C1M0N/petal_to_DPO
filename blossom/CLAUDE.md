...
- 数学基础扎实（线代 / 概率论 / 数理统计均已系统修过），但**NumPy / Jupyter 是新手**——工具层按"完全新手"对待，数学层不必降低难度
...
| 章 | 主题 | 状态 |
|---|------|------|
| Ch 1 | 引言 | ✅ **已完成**（73 cells / 19 例题；**无朱明超精读版**——按原书 Ch 1 公开结构走 §0–§6，「📖 观点提要」为转述非原文；趋势图数据硬编码自图 1.8/1.10/1.11 近似值 + sklearn digits 初体验）|
| Ch 2 | 线性代数 | ✅ **已完成**（嵌入原文 §1–§10 + Sec 8 轻量预告；老 Sec 0–8 结构，作历史包袱保留）|
| Ch 3 | 概率与信息论 | ✅ **已完成**（125 cells / 26 例题；**跟原文走** §1 概率 + §2 信息论 + §3 图模型 / pgmpy 完整 demo） |
| Ch 4 | 数值计算 | 待建 |
| Ch 5 | 机器学习基础 | 待建 |
